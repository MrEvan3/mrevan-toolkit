...
📊 [5] Diagnóstico do PC
Traz um fetch rápido do sistema exibindo SO, build, modelo da CPU, GPU, quantidade de RAM, tempo de atividade (uptime), e capacidade/espaço livre de todos os discos físicos (com alertas de cor se o disco estiver lotado).

Oferece atalhos diretos para as ferramentas nativas de diagnóstico da Microsoft (msinfo32, resmon, dxdiag).

🧰 [6] Utilitários Extras
Atalhos rápidos para menus vitais que costumam ficar escondidos no Windows: Limpeza de Disco (cleanmgr), Configurações de Armazenamento, Programas e Recursos (appwiz.cpl) e Propriedades de Desempenho Visual.
...
Wipe de Logs: Usa o wevtutil para limpar absolutamente todos os logs do Visualizador de Eventos, deixando a máquina com a "ficha limpa" para diagnósticos precisos.
...
Modo Pânico: Reseta o Firewall do Windows aos padrões de fábrica e desbloqueia a conta nativa e oculta de Super Administrador para emergências e perfis corrompidos.
...
: Criado por Chris Titus Tech. Invocado no menu [4] como uma alternativa gráfica e complementar para instalar pacotes e aplicar MicroTweaks.
...
[https://github.com/MrEvan3/mrevan-toolkit](https://github.com/MrEvan3/mrevan-toolkit)
